...
/* Define to 1 if you have the <boost/functional/hash/hash.hpp> header file.
   */
...
/* Define to 1 if you have the <boost/random/normal_distribution.hpp> header
   file. */
#define HAVE_BOOST_RANDOM_NORMAL_DISTRIBUTION_HPP 1
...
/* Define to 1 if you have the <boost/random/uniform_real.hpp> header file. */
#define HAVE_BOOST_RANDOM_UNIFORM_REAL_HPP 1

/* Define to 1 if you have the <boost/random/variate_generator.hpp> header
   file. */
#define HAVE_BOOST_RANDOM_VARIATE_GENERATOR_HPP 1
...
/* Define to 1 if you have the file `AC_File'. */
#define HAVE_INC_COORDINATES_H 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_INC_CURESOURCES_H 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_INC_GEODESICS_H 1
...
/* Define to 1 if you have the file `AC_File'. */
#define HAVE_SRC_AUTOCORR2_CU 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_SRC_CAUSET_CU 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_SRC_CURESOURCES_CU 1

/* Define to 1 if you have the file `AC_File'. */
#define HAVE_SRC_MEASUREMENTS_CU 1
